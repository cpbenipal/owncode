...
using PanelMasterMVC5Separate.Localization.Dto;
using PanelMasterMVC5Separate.Migrations.Seed.Host;
using Shouldly;
using Xunit;

namespace PanelMasterMVC5Separate.Tests.Localization
{
    public class LanguageAppService_Tests : AppTestBase
    {
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = PanelMasterMVC5SeparateConsts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
            ...
            var newValue = Resolve<ILocalizationManager>()
                .GetString(
                    PanelMasterMVC5SeparateConsts.LocalizationSourceName,
                    "Save",
