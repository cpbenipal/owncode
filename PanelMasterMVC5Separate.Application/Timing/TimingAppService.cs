...
using PanelMasterMVC5Separate.Timing.Dto;

namespace PanelMasterMVC5Separate.Timing
{
    public class TimingAppService : PanelMasterMVC5SeparateAppServiceBase, ITimingAppService
    {
