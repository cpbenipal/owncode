...
namespace PanelMasterMVC5Separate.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : PanelMasterMVC5SeparateServiceBase, ITransientDependency
    {
