...
using PanelMasterMVC5Separate.Caching.Dto;

namespace PanelMasterMVC5Separate.Caching
{
    [AbpAuthorize(AppPermissions.Pages_Administration_Host_Maintenance)]
    public class CachingAppService : PanelMasterMVC5SeparateAppServiceBase, ICachingAppService
    {
