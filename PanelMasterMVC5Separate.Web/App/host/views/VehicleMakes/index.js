(function () {
    ...
    appModule.controller('host.views.VehicleMakes.index', [
        ...
        function ($scope, $uibModal, $stateParams, uiGridConstants, userService) {
                ...
                columnDefs: [
                    {
                        ...
                        '      <li><a ng-if="grid.appScope.permissions.edit"  ng-click="grid.appScope.edit(row.entity.makeID)">' + app.localize('Open') + '</a></li>' +                         
                        '    </ul>' +
                        '  </div>' +
                        '</div>'
                    },
            ...
            vm.edit = function (makeId) {
                openCreateOrEditUserModal(makeId);
            };

            vm.addNewMake = function () {
                openCreateOrEditUserModal(null);
            };
            function openCreateOrEditUserModal(makeId) {

                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/host/views/VehicleMakes/createOrEditModal.cshtml',
                    controller: 'host.views.VehicleMakes.createOrEditModal as vm',
                    backdrop: 'static',
                    resolve: {
                        makeId: function () {
                            return makeId;
