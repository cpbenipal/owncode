(function () {
    ...
    appModule.controller('host.views.SignonPlans.index', [
        ...
        function ($scope, $uibModal, $stateParams, uiGridConstants, userService) {
            ...
            function openCreateOrEditUserModal(quoteId) {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/host/views/SignonPlans/createOrEditModal.cshtml',
                    controller: 'host.views.SignonPlans.createOrEditModal as vm',
                    backdrop: 'static',
                    resolve: {
                        quoteId: function () {
                            return quoteId;
