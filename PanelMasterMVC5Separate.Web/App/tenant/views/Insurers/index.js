                ...
                columnDefs: [
                    {
                        ...
                        '      <li><a ng-if="grid.appScope.permissions.edit" ng-href="#!/tenant/EditInsurer/{{row.entity.id}}">' + app.localize('Open') + '</a></li>' +                         
                    ...
                    },
                    {
                        ...
                        cellTemplate:
                        '<div class=\"ui-grid-cell-contents\">' +
                        '<a ng-show="row.entity.isActive" ng-href="#!/tenant/EditInsurerSub/{{row.entity.id}}" class="btn btn-xs btn-primary blue">' + app.localize('EDIT') + '</a>' +
                        '</div>',
                        minWidth: 50
                    },
                    {
                        ...
                        cellTemplate:
                        '<div class=\"ui-grid-cell-contents\">' +
                        '  <img ng-if="row.entity.id" ng-src="' + abp.appPath + 'Insurer/GetProfilePictureById?id={{row.entity.id}}" width="22" height="22" class="img-rounded img-profile-picture-in-grid" />' +
