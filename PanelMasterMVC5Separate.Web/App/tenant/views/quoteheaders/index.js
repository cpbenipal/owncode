        ...
        function ($scope, $uibModal, $stateParams, uiGridConstants, jobService) {
            ...
            vm.getHeaders = function () {
                ...
                jobService.getHeaders()
                    .then(function (result) {
                        ...
                        //editableGrid.setCellRenderer("actions", new CellRenderer({
                        //    render: function (cell, value) {

                        //        jobService.getActions(value)
                        //            .then(function (actions) {                                      
                        //                var options = actions.data;                                        
                        ...
                        editableGrid.setCellRenderer("copydelete", new CellRenderer({
                            render: function (cell, value) {
                                cell.innerHTML = cell.innerHTML + "<a onclick=\"if (confirm('Are you sure you want to delete this line ? ')) deleteRow(" + cell.rowIndex + ");\" style=\"cursor:pointer\">" +
                                    ...
                                    "<i class=\"fa fa-plus\" title=\"addnew\"></i></a>";
                            }
                        }));
            ...
            vm.save = function () {
                ...
                $('#htmlgrid tbody tr').each(function (i, tr) {
                    //alert($('#htmlgrid tbody tr').attr("id"));
                    //if ($scope.isShow != false && $('#htmlgrid tbody tr').attr("id") == "R" + i + "") {
                    quote.push({
                        ...
                        "notaxvat": editableGrid.getValueAt(i, 19),
