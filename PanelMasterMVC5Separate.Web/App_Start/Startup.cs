...
using PanelMasterMVC5Separate.WebApi.Controllers;
using Owin;
...
namespace PanelMasterMVC5Separate.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //Enable it to use HangFire dashboard (uncomment only if it's enabled in PanelMasterMVC5SeparateWebModule)
            ...
            var options = new OpenIdConnectAuthenticationOptions
            {
                ...
                Notifications = new OpenIdConnectAuthenticationNotifications
                {
                    SecurityTokenValidated = notification =>
                    {
                        ...
                        notification.AuthenticationTicket.Identity.AddClaim(new System.Security.Claims.Claim(ClaimTypes.Email, email));
            ...
            return new TwitterAuthenticationOptions
            {
                ...
                Provider = new TwitterAuthenticationProvider
                {
                    OnAuthenticated = (context) =>
                    {
                        ...
                        context.Identity.AddClaim(new System.Security.Claims.Claim(ClaimTypes.Email, email));
            ...
            return new WsFederationAuthenticationOptions
            {
                ...
                Notifications = new WsFederationAuthenticationNotifications
                {
                    ...
                    SecurityTokenValidated = notification =>
                    {
                        ...
                        if (emailClaim != null)
                        {
                            notification.AuthenticationTicket.Identity.AddClaim(new System.Security.Claims.Claim(ClaimTypes.Email, emailClaim.Value));
                        }
