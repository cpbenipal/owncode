...
using PanelMasterMVC5Separate.Web.App.Startup;//SPA!
using PanelMasterMVC5Separate.Web.Bundling;
using PanelMasterMVC5Separate.Web.Navigation;
using PanelMasterMVC5Separate.Web.Routing;
using PanelMasterMVC5Separate.WebApi;
...
namespace PanelMasterMVC5Separate.Web
{
    ...
    [DependsOn(
        ...
        typeof(PanelMasterMVC5SeparateWebApiModule),
    ...
    public class PanelMasterMVC5SeparateWebModule : AbpModule
    {
