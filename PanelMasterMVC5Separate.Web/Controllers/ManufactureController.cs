...
using PanelMasterMVC5Separate.Tenants.Manufacturing;

namespace PanelMasterMVC5Separate.Web.Controllers
{
    public class ManufactureController : PanelMasterMVC5SeparateControllerBase
    { 
        private readonly IManufactureAppService _binaryObjectManager;
        private readonly IAppFolders _appFolders;       

        public ManufactureController(
            IManufactureAppService binaryObjectManager,
        ...
        public JsonResult UploadProfilePicture()
        {
            try
            {
                ...
                AppFileHelper.DeleteFilesInFolderIfExists(_appFolders.TempFileDownloadFolder, "vehiclemake_" + AbpSession.GetUserId());
