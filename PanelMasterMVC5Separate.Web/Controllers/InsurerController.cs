...
{ 
    public class InsurerController : PanelMasterMVC5SeparateControllerBase
    { 
        private readonly IInsurerAppService _binaryObjectManager;
        private readonly IAppFolders _appFolders;       

        public InsurerController(         
            IInsurerAppService binaryObjectManager,
        ...
        public JsonResult UploadProfilePicture()
        {
            try
            {
                ...
                AppFileHelper.DeleteFilesInFolderIfExists(_appFolders.TempFileDownloadFolder, "InsurerImage_" + AbpSession.GetUserId());
