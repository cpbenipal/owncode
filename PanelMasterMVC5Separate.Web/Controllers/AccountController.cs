...
using PanelMasterMVC5Separate.Authorization.Impersonation;
...
using PanelMasterMVC5Separate.Web.Controllers.Results;
using PanelMasterMVC5Separate.Web.Models.Account;
...
using PanelMasterMVC5Separate.Web.Models.Layout;

namespace PanelMasterMVC5Separate.Web.Controllers
{
    public class AccountController : PanelMasterMVC5SeparateControllerBase
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = Authorization.Claim.User.CreateRandomPassword();
        ...
        private static bool TryExtractNameAndSurnameFromClaims(List<System.Security.Claims.Claim> claims, ref string name, ref string surname)
        {
        ...
        public virtual async Task<ActionResult> ImpersonateSignIn(string tokenId)
        {
            ...
            if (!cacheItem.IsBackToImpersonator)
            {
                ...
                {
                    identity.AddClaim(new System.Security.Claims.Claim(AbpClaimTypes.ImpersonatorTenantId, cacheItem.ImpersonatorTenantId.Value.ToString(CultureInfo.InvariantCulture)));
                }

                identity.AddClaim(new System.Security.Claims.Claim(AbpClaimTypes.ImpersonatorUserId, cacheItem.ImpersonatorUserId.ToString(CultureInfo.InvariantCulture)));
            }
        ...
        public virtual async Task<ActionResult> SwitchToLinkedAccountSignIn(string tokenId)
        {
            ...
            {
                identity.AddClaim(new System.Security.Claims.Claim(AbpClaimTypes.ImpersonatorUserId, cacheItem.ImpersonatorUserId.Value.ToString(CultureInfo.InvariantCulture)));
            }
